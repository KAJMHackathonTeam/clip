...
class Dashboard extends React.Component {
    ...
    async updateLocalData() {
            ...
            const messagesAll = await DataStore.query(Message);
            const organizationsAll = await DataStore.query(Organization);
            const responsesAll = await DataStore.query(Response);
